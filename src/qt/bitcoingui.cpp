...
void BitcoinGUI::createActions()
{
	...
	statisticsAction->setStatusTip(tr("Haru Statistics"));
	...
	marketAction->setStatusTip(tr("Haru Market Data"));
	...
	sendCoinsAction->setStatusTip(tr("Send Haru"));
	...
	receiveCoinsAction->setStatusTip(tr("Receive Haru"));
    ...
    fortunastakeManagerAction->setToolTip(tr("Show Haru Fortuna Stakes status and configure your nodes."));
    ...
    openPeerAction->setStatusTip(tr("Show Haru network peers"));
...
void BitcoinGUI::showConfEditor()
{
    ...
    if (boost::filesystem::exists(pathConfig)) {
        ...
        tr("Your denarius.conf does not exist! Please create one in your Haru data directory."),
...
void BitcoinGUI::showMNConfEditor()
{
    ...
    if (boost::filesystem::exists(pathMNConfig)) {
        ...
        tr("Your fortunastake.conf does not exist! Please create one in your Haru data directory."),
        QMessageBox::Ok, QMessageBox::Ok);
	}
